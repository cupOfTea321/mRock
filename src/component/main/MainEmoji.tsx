...
import item2 from "../../assets/items/item9.png";
      ...
      <Box
         ...
         <Container
            ...
            <Box
               ...
               <Typography variant={"h2"}>Испытайте</Typography>
               <ItemText
                  sx={{
                     backgroundImage: `url(${item2})`,
                     width: { md: "360px", sm: "300px", xs: "231px" },
                  ...
                  title={"самую сильную"}
               />
               <Typography variant={"h2"}>музыкальную эмоцию,</Typography>
            </Box>
            <Typography variant={"h2"}>
               доступную лишь настоящим рок-звездам. Станьте частью самого
               масштабного рок-события 2024 года
            </Typography>
            <Box
               sx={{
                  display: "flex",
